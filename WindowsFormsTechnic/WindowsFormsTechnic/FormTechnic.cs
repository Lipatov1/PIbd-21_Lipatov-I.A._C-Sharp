...
namespace WindowsFormsTechnic {
	public partial class FormTechnic : Form {
		...
		// Передача техники на форму
		public void SetTransport(ITransport technic) {
		...
		private void buttonCreateArmoredCar_Click(object sender, EventArgs e) {
			...
			technic = new ArmoredCar(rnd.Next(100, 300), rnd.Next(1000, 2000), ColorTranslator.FromHtml("#424724"));
		...
		private void buttonCreateArtillery_Click(object sender, EventArgs e) {
			Random rnd = new Random();
			technic = new Artillery(rnd.Next(100, 300), rnd.Next(1000, 2000), ColorTranslator.FromHtml("#35391f"), Color.Red, true, true, true);
			technic.SetPosition(rnd.Next(10, 100), rnd.Next(10, 100), pictureBoxTechnic.Width, pictureBoxTechnic.Height);
			Draw();
		}
